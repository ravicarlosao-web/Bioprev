...
export default function Services() {
  ...
  const card2 = useScrollReveal(0.2);

  return (
    <section id="services-section" className="w-full bg-[#f2f2f2] pb-16">
      <div className="grid grid-cols-1 md:grid-cols-2">
        
        <div ref={card1.ref} className="relative group overflow-hidden h-[400px] sm:h-[450px] md:h-[500px]">
          <img 
            src={services1Img}
          ...
          <div className="absolute inset-0 flex items-center justify-center md:justify-start md:pl-[15%]">
            <div className={`bg-white border-t-4 border-[#f2c92f] p-6 sm:p-8 md:p-10 z-10 w-[88%] sm:w-[85%] md:w-[380px] shadow-xl sr-left ${card1.isVisible ? 'sr-visible' : ''}`}>
        ...
        <div ref={card2.ref} className="relative group overflow-hidden h-[400px] sm:h-[450px] md:h-[500px]">
          ...
          />
          <div className="absolute inset-0 flex items-center justify-center md:justify-start md:pl-[15%]">
            <div className={`bg-white border-t-4 border-[#f2c92f] p-6 sm:p-8 md:p-10 z-10 w-[88%] sm:w-[85%] md:w-[380px] shadow-xl sr-right ${card2.isVisible ? 'sr-visible' : ''}`}>
