...
const data: ServicePageData = {
  ...
  details: [
    ...
    { icon: Archive, title: "Controlo de traças e carunchos", description: "Gorgulhos, traças e carunchos são pragas de produtos armazenados que causam perdas económicas avultadas. Os gorgulhos infestam cereais, farinhas, grãos, frutas secas, nozes, sementes e tabaco, enquanto traças e carunchos danificam igualmente produtos alimentares, têxteis, documentos históricos e coleções de museu. Oferecemos tratamentos especializados para silos, armazéns, indústria alimentar, museus, arquivos e lojas têxteis, eliminando estas pragas em todas as fases do ciclo de vida com métodos seguros e eficazes." },
