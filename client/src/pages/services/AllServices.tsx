      ...
      <main className="flex-grow">
          ...
          <div className="container mx-auto px-4 z-10">
            <div className="max-w-4xl">
              ...
              <h1 className="text-white text-5xl md:text-6xl font-medium mb-8 leading-tight">
                Global pest control services<br />and solutions
              </h1>
              
              <p className="text-white text-xl md:text-[22px] max-w-3xl mb-12 leading-relaxed font-light">
                As the global leader in pest control and hygiene solutions, Rentokil brings expert, reliable and professional services to commercial customers all over the world.
              </p>
        ...
        <section className="py-20 bg-white">
          <div className="container mx-auto px-4 max-w-4xl text-center">
            <p className="text-[#333333] text-lg mb-8 leading-relaxed font-medium">
              Rentokil has been protecting people, homes, and businesses from the dangers of poor hygiene and pest-borne diseases for 100 years.
            </p>
            <p className="text-[#666666] text-base mb-16 leading-relaxed">
              We believe that innovation is a key factor to success. Our <span className="text-[#007cc3] cursor-pointer hover:underline">global research and development centre</span> provides our front-line colleagues with the tools and solutions they need to deliver <span className="text-[#007cc3] cursor-pointer hover:underline">differentiated pest control services</span>. Rentokil is committed to <span className="text-[#007cc3] cursor-pointer hover:underline">sustainability</span> and exploring the use of greener, non-toxic solutions, while continuing to offer our customers the high levels of pest protection their businesses need.
            </p>
            
            <h2 className="text-3xl md:text-[40px] font-medium text-[#333333] mb-8 leading-tight">
              Commercial pest control and disinfection services
            </h2>
            <p className="text-[#666666] text-base leading-relaxed">
              Rentokil pest control is dedicated to keeping your staff, customers, and brand reputation protected with industry-leading <span className="text-[#007cc3] cursor-pointer hover:underline">pest control services</span> that are tailored to your business and fully support regulatory compliance. With hygiene remaining a priority in the aftermath of the COVID-19 pandemic, our <span className="text-[#007cc3] cursor-pointer hover:underline">disinfection services</span> can help safeguard your business for the future.
            </p>
          </div>
        </section>
        ...
        <section className="grid grid-cols-1 md:grid-cols-2">
          ...
          <div className="relative h-[600px] group overflow-hidden">
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-md px-4">
              <div className="bg-white border-t-4 border-[#e31837] shadow-xl p-10">
                <h3 className="text-2xl md:text-[28px] font-medium text-[#333333] mb-6">Pest control services</h3>
                <p className="text-[#666666] leading-relaxed mb-8">
                  Rentokil is the global leader in commercial pest control. We offer a range of innovative, targeted treatments and proofing solutions to ensure your business stays pest-free.
                </p>
          ...
          <div className="relative h-[600px] group overflow-hidden">
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-md px-4">
              <div className="bg-white border-t-4 border-[#e31837] shadow-xl p-10">
                <h3 className="text-2xl md:text-[28px] font-medium text-[#333333] mb-6">Digital pest control</h3>
                <p className="text-[#666666] leading-relaxed mb-8">
        ...
        <section className="py-24 bg-white">
          <div className="container mx-auto px-4 max-w-6xl text-center">
            ...
            <p className="text-[#666666] max-w-4xl mx-auto mb-16 leading-relaxed">
              Rentokil offers integrated pest management (IPM) programmes tailored to individual client needs, fully supporting regulatory and auditing requirements. Our 100-year history gives us the knowledge and experience to identify and anticipate <span className="text-[#007cc3] cursor-pointer hover:underline">pest</span> and <span className="text-[#007cc3] cursor-pointer hover:underline">hygiene</span> threats to your business.
            </p>
                ...
                <Accordion type="single" collapsible key={idx} className="w-full">
                  <AccordionItem value={`item-${idx}`} className="border-none">
                    ...
                    <AccordionContent className="bg-white px-8 py-6 text-left text-[#666666] leading-relaxed border-x border-b border-[#d0dae1]">
                      Detailed information about {step} would go here, explaining the specific methodologies and benefits of this phase in the IPM process.
                    </AccordionContent>
                  </AccordionItem>
                </Accordion>
              ))}
          ...
          <div className="container mx-auto px-4 max-w-6xl">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="bg-white border-t-4 border-[#e31837] shadow-lg p-10 flex flex-col h-full">
                ...
                <h3 className="text-[22px] font-medium text-[#333333] mb-6 text-center">1. Pest risk assessment</h3>
                <p className="text-[#666666] text-sm mb-8 text-center leading-relaxed">
                  Hassle-free pest survey and consultation
                </p>
                <div className="space-y-2 mt-auto">
                  {["Scheduled pest inspection at a time of your convenience", "On-site pest risk review and consultancy", "No-obligation quote and recommendations"].map((item, i) => (
              ...
              <div className="bg-white border-t-4 border-[#e31837] shadow-lg p-10 flex flex-col h-full">
                ...
                <h3 className="text-[22px] font-medium text-[#333333] mb-6 text-center">2. Pest treatment</h3>
                <p className="text-[#666666] text-sm mb-8 text-center leading-relaxed">
                  Comprehensive pest treatment programme tailored to your needs
                </p>
                <div className="space-y-2 mt-auto">
                  {["Certified, local pest control experts", "Environmentally-sensitive approach", "Industry-specific legislation expertise ensures audit compliance"].map((item, i) => (
                    <div key={i} className="bg-[#f2f5f7] p-4 text-[13px] text-[#333333] leading-tight">
                      {item}
                    </div>
                  ))}
              ...
              <div className="bg-white border-t-4 border-[#e31837] shadow-lg p-10 flex flex-col h-full">
                ...
                <h3 className="text-[22px] font-medium text-[#333333] mb-6 text-center">3. Pest protection (Aftercare)</h3>
                <p className="text-[#666666] text-sm mb-8 text-center leading-relaxed">
                  Ensuring a clean, safe environment post-treatment
                </p>
                <div className="space-y-2 mt-auto">
                  {["Integrated Pest Management (IPM) solutions", "Detailed post-service recommendations", "Pest prevention aftercare and advice"].map((item, i) => (
                    <div key={i} className="bg-[#f2f5f7] p-4 text-[13px] text-[#333333] leading-tight">
                      {item}
                    </div>
                  ))}
        ...
        <section className="bg-[#007cc3] py-16 text-center">
          <div className="container mx-auto px-4">
            <h2 className="text-white text-3xl font-medium mb-8">Book your pest risk assessment today</h2>
            <Button 
